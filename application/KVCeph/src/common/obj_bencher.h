...
protected:
  ...
  int write_bench(int secondsToRun, int concurrentios, const string& run_name_meta, unsigned max_objects, int run_name = 0);
...
public:
  ...
  int aio_bench(
    ...
    bool cleanup, bool hints, const int run_name, bool no_verify=false);
