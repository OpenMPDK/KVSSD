...
public:
  ...
  public:
    ...
    TPHandle(
      ...
      time_t suicide_grace,
      int thread_index)
      : cct(cct), hb(hb), grace(grace), suicide_grace(suicide_grace), thread_index(thread_index) {}
...
private:
  ...
  struct WorkThread : public Thread {
    ...
    WorkThread(ThreadPool *p, int thread_index) : pool(p), thread_index(thread_index) {}
    void *entry() override {
      pool->worker(this);
      return 0;
    }
...
public:
  ...
  public:
    ...
    void drain() {
      ...
      virtual void create_pgshard(spg_t pgid) {}
      virtual void remove_pgshard(spg_t pgid) {}
