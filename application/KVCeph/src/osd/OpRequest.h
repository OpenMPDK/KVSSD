...
private:
  ...
  // opwq pg lock time
  utime_t pglock_start_opwq;
  utime_t pglock_end_opwq;
...
public:
  ...
  // pg lock time at opwq
  utime_t get_pglock_start_time() const {
    return pglock_start_opwq;
  }
  void set_pglock_start_time(utime_t lock_time) {
    pglock_start_opwq = lock_time;
  }
  utime_t get_pglock_end_time() const {
    return pglock_end_opwq;
  }
  void set_pglock_end_time(utime_t lock_time) {
    pglock_end_opwq = lock_time;
  }
