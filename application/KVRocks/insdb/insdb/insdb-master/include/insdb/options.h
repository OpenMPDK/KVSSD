...
namespace insdb {
    ...
    struct INSDB_EXPORT Options {
        ...
        /**
          ...
          InSDB will set defaut rather than user supplied size.
...
*/
        ...
        /**
          When reclaim happen, it will reclaime memory until given %.
          eq, 100MB cache with cache_threshold(70) will reclaim cache until
          cache capacity reaches to 70MB.
          User can adjust this value, But if value beyond default, InSDB will
          pick value from default range rather than user supplied value.
...
*/
        ...
        /**
          Low watermark to finish SKTable eviction
          Default 500k
          */
        size_t sktable_low_key_count;
        /**
          High watermark to kick off SKTable eviction
          Default 900k
          */
        size_t sktable_high_key_count;
        /**
          Max SKTables in device format
         */
        size_t max_sktable_deviceformat;
        /**
